...
const FIELD_CLASS =
  'input-surface mt-2 w-full rounded-2xl px-4 py-3.5 text-[15px] text-text outline-none transition placeholder:text-text-muted focus:border-accent focus:bg-surface-strong';
    ...
    <form className="space-y-6" onSubmit={onSubmit}>
        ...
        <div className="mt-3 grid gap-3 lg:grid-cols-3">
          {SOURCE_TYPE_OPTIONS.map((option) => (
            ...
            >
              ...
              />
              <span>
                <span className="block text-base font-semibold text-text">{option.label}</span>
      ...
      <div className="flex flex-col gap-3 sm:flex-row">
        <button
          ...
          className="ghost-surface inline-flex min-h-12 items-center justify-center rounded-full px-5 text-[15px] font-semibold text-text transition hover:border-accent hover:bg-surface-strong disabled:cursor-wait disabled:opacity-60"
        >
        ...
        <button
          ...
          className="inline-flex min-h-12 items-center justify-center rounded-full bg-accent px-5 text-[15px] font-semibold text-accent-contrast transition hover:bg-[#72e79a] disabled:cursor-wait disabled:opacity-60"
        >
