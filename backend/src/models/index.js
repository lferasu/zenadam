import { createCandidateSourceIndexes } from './CandidateSource.js';
...
export { CANDIDATE_SOURCE_COLLECTION, CANDIDATE_SOURCE_STATUS } from './CandidateSource.js';
...
export const ensureModelIndexes = async (db) => {
  await Promise.all([
    createCandidateSourceIndexes(db),
